...
public class ExceptionAdviceHandler {
    ...
    public ResultView requestHandlingNoHandlerFound(HttpServletRequest request, Exception e) {
        log(ErrorCode.HTTP_NOT_FOUND, request, e);
        return ResultView.failed(ErrorCode.HTTP_NOT_FOUND, getMessage(ErrorCode.HTTP_NOT_FOUND));
    }
...
//            MissingServletRequestParameterException.class, ServletRequestBindingException.class,
    ...
    public ResultView requestHandlingHttpMediaTypeNotSupported(HttpServletRequest request, Exception e) {
        log(ErrorCode.UNSUPPORTED_MEDIA, request, e);
        return ResultView.failed(ErrorCode.UNSUPPORTED_MEDIA, getMessage(ErrorCode.UNSUPPORTED_MEDIA));
    }
    ...
    public ResultView requestHandlingInternalError(HttpServletRequest request, Exception e) {
        log(ErrorCode.INTERNAL_ERROR, request, e);
        return ResultView.failed(ErrorCode.INTERNAL_ERROR, getMessage(ErrorCode.INTERNAL_ERROR));
    }
    ...
    public ResultView handleMethodArgumentNotValidException(Exception e) {
        ...
        return ResultView.failed(ErrorCode.BAD_REQUEST, errMsg);
    }
