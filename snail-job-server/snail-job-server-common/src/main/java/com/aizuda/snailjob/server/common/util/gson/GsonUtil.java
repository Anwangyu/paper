...
//    }
//
//    public static String getStringByPath(JsonObject jo, String ... pathNodes) {
//        JsonElement je = getJsonElementByPath(jo, pathNodes);
...
//        }
//    }
//    public static Integer getIntegerByPath(JsonObject jo, String ... pathNodes) {
//        JsonElement je = getJsonElementByPath(jo, pathNodes);
...
//    }
//
//    public static Long getLongByPath(JsonObject jo, String ... pathNodes) {
//        JsonElement je = getJsonElementByPath(jo, pathNodes);
//        if(je != null && je.isJsonPrimitive()){
//            String str = je.toString();
...
//    }
//
//    public static JsonElement getJsonElementByPath(JsonObject jo, String ... pathNodes) {
//        int len = pathNodes.length;
//        JsonElement rt = null;
//        for (int i = 0; i < len; i++) {
//            String pathNode = pathNodes[i];
//            JsonElement je = jo.get(pathNode);
//            if(i == len - 1){
//                if(je != null){
//                    rt = je;
//                }
...
//    }
//
//    public static JsonElement deepMergeJson(JsonElement origin, JsonElement update, int depth, int maxDepth) {
//        int cur = depth;
//        if (cur > maxDepth) {
//            throw new RuntimeException("merge json error, depth beyond " + maxDepth + "!");
//        }
//        if (origin == null || origin.isJsonNull() || update == null || update.isJsonNull()) {
//            return update;
//        }
//        if (update.isJsonPrimitive()) {
...
//            }
//            ++cur;
//            JsonObject originJson = origin.getAsJsonObject();
//            JsonObject updateJson = update.getAsJsonObject();
//            for (Map.Entry<String, JsonElement> entry : updateJson.entrySet()) {
//                String key = entry.getKey();
//                JsonElement e2 = entry.getValue();
//                JsonElement e1 = originJson.get(key);
//
//                JsonElement merge = deepMergeJson(e1, e2, cur, maxDepth);
//                originJson.add(key, merge);
//            }
//            return originJson;
//        }
//
//        if (update.isJsonArray()) {
//            if (!origin.isJsonArray()) {
//                return update;
//            }
//            ++cur;
//            JsonArray originJson = origin.getAsJsonArray();
//            JsonArray updateJson = update.getAsJsonArray();
//            if (originJson.size() != updateJson.size()) {
//                return originJson.size() > updateJson.size() ? originJson : updateJson;
//            }
//            for (int i = 0; i < updateJson.size(); i++) {
//                JsonElement e1 = originJson.get(i);
//                JsonElement e2 = updateJson.get(i);
//
//                JsonElement merge = deepMergeJson(e1, e2, cur, maxDepth);
//                originJson.set(i, merge);
//            }
//            return originJson;
//        }
//
...
//    }
//
//    public static List<Map<String, Object>> parseFieldInfo(String fieldInfoJson) {
//        Map<String, Object> fieldInfo = fromJson(fieldInfoJson, new TypeToken<Map<String, Object>>() {}.getType());
//        return fromJson(toJson(fieldInfo.get("field_info")), new TypeToken<List<Map<String, Object>>>() {}.getType());
//    }
//
//    public static <T> T getObject(String json,String key, Class<T> clazz) {
//        JsonObject jo = GsonUtil.parseJsonObjectIfNotNull(json);
//        if(jo!=null){
//            return getBean(jo,key,clazz);
//        }
//        return null;
//    }
//}
