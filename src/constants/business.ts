...
export const vehicleTypeRecord: Record<Api.VehicleManager.VehicleType, App.I18n.I18nKey> = {
  ...
  Coupe: 'page.vehicleManager.type.Coupe',
  Supercar: 'page.vehicleManager.type.Supercar',
  Jeep: 'page.vehicleManager.type.Jeep',
  Minivan: 'page.vehicleManager.type.Minivan',
  StationWagon: 'page.vehicleManager.type.StationWagon',
  Truck: 'page.vehicleManager.type.Truck',
  Bus: 'page.vehicleManager.type.Bus',
  Hybrid: 'page.vehicleManager.type.Hybrid',
  EV: 'page.vehicleManager.type.EV',
  Pickup: 'page.vehicleManager.type.Pickup'
};
