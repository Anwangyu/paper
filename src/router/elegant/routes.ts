...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      icon: 'streamline:ai-vehicle-spark-1-solid',
      order: 950,
      keepAlive: false
    },
    children: [
      {
        ...
        component: 'view.vehicle_manager',
        meta: {
          title: 'vehicle_manager',
          i18nKey: 'route.vehicle_manager',
          icon: 'streamline:ai-vehicle-spark-1',
          order: 950,
          keepAlive: false
        }
      }
