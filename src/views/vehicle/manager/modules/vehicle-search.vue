...
const model = defineModel<Api.VehicleManager.VehicleSearchParams>('model', { required: true });

type RuleKey = Extract<keyof Api.VehicleManager.VehicleSearchParams, 'userEmail' | 'userPhone'>;
