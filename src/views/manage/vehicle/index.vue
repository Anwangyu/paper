...
import { fetchGetVehicleList } from '@/service/api'; // 更新为车辆相关 API 方法
...
const {
  ...
  columns: () => [
    ...
    { key: 'vehicleName', title: $t('page.manage.vehicle.vehicleName'), minWidth: 100 },
    {
      key: 'vehicleType',
      title: $t('page.manage.vehicle.vehicleType'),
      width: 100,
      render: row => {
    ...
    { key: 'vehicleParts', title: $t('page.manage.vehicle.vehicleParts'), minWidth: 100 },
    { key: 'vehicleDriver', title: $t('page.manage.vehicle.vehicleDriver'), width: 120 },
    { key: 'vehicleDispatchInfo', title: $t('page.manage.vehicle.vehicleDispatchInfo'), minWidth: 200 },
    {
      key: 'status',
      title: $t('page.manage.vehicle.vehicleStates'),
      align: 'center',
      width: 100,
      render: row => {
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard :title="$t('page.manage.vehicle.title')" :bordered="false" size="small"
