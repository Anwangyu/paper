        ...
        <ElForm ref="formRef" :model="model" :rules="rules" label-position="right" :label-width="80">
          <ElRow :gutter="24">
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="$t('page.manage.vehicle.vehicleName')" prop="vehicleName">
                <ElInput v-model="model.vehicleName" :placeholder="$t('page.manage.vehicle.form.vehicleName')" />
              </ElFormItem>
            </ElCol>
            <ElCol :lg="6" :md="8" :sm="12" :label="$t('page.manage.vehicle.vehicleType')">
              <ElFormItem :label="$t('page.manage.vehicle.vehicleType')" prop="vehicleType">
                <ElSelect
            ...
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="$t('page.manage.vehicle.vehicleParts')" prop="vehicleParts">
                <ElInput v-model="model.vehicleParts" :placeholder="$t('page.manage.vehicle.form.vehicleParts')" />
              </ElFormItem>
            </ElCol>
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="$t('page.manage.vehicle.vehiclePersonCharge')" prop="vehiclePersonCharge">
                <ElInput
            ...
            <ElCol :lg="6" :md="8" :sm="12">
              <ElFormItem :label="$t('page.manage.vehicle.vehicleStates')" prop="vehicleStates">
                <ElSelect
                  v-model="model.vehicleStates"
                  clearable
                  :placeholder="$t('page.manage.vehicle.form.vehicleStates')"
                >
                  <ElOption
